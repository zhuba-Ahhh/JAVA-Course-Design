...
public class PlayBean {
    ...
    public PlayBean(int id, String soundName, String artist, String album,  String time, WritableImage image, int totalSeconds, String filePath, MediaPlayer mediaPlayer, String lrcPath) {
        this.id = id;
