...
public class ConnectionShow extends JFrame implements ActionListener{
	ConnectionClient panel2 ;
	...
	int level;
	MusicPlay Music;
	public ConnectionShow(int n,int level)throws UnknownHostException, IOException, InterruptedException{
		this.level=level;
        panel2=new ConnectionClient(10,n);
		...
		this.setTitle("连连看游戏1");//窗口标题为连连看游戏
