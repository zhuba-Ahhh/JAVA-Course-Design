...
CREATE TABLE `users_informations` (
  ...
  UNIQUE KEY `users_informations_username_uindex` (`username`)
...
INSERT INTO `users_informations` VALUES ('chengzi','753412'),('liuwuxuan','2002725'),('xiaojr','xiaoge123'),('zyz','20021003'),('root','root'),('chunlin','581491'),('qwe','123'),('上号提示音','1111');
...
-- Dump completed on 2022-01-12  9:26:48
