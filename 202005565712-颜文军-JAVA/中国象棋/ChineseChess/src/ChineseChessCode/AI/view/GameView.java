package ChineseChessCode.AI.view;

import ChineseChessCode.AI.chess.Board;
import ChineseChessCode.AI.chess.Piece;
import ChineseChessCode.AI.chess.Rules;
import ChineseChessCode.AI.control.GameController;
...
public class GameView {
    ...
    private final Map<String, JLabel> pieceObjects = new HashMap<>();
    private Board board;
    ...
    public void init(final Board board) {
        this.board = board;
        frame = new JFrame("Chinese Chess @YanWenJun");
    ...
    class PieceOnClickListener extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            if (selectedPieceKey != null && key.charAt(0) != board.player) {
                ...
                for (int[] each : Objects.requireNonNull(Rules.getNextMove(selectedPieceKey, selectedPiecePos, board))) {
